...
public class Step0GetTempAuthCode extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse res) throws ServletException, IOException {
		...
		String urlRedirect = "https://github.com/login/oauth/authorize?client_id=ca9ff4fb657deb4f4f4c&scope=user&redirect_uri=https://oauth-sandeep.appspot.com/GitHub/Step1GetAccessToken&state=1" ;
